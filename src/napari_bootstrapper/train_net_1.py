...
def lsd_outpainting_pipeline(
    ...
    source = gp.ZarrSource(
        "test_data.zarr",
        {raw: "image", labels: "labels", unlabelled: "unlabelled"},
        {
    ...
    source += gp.RandomLocation(mask=unlabelled, min_masked=min_masked)
    ...
    pipeline += gp.torch.Train(
        ...
        # checkpoint_basename='checkpoints/lsd_outpainting',
        log_dir="logs/lsd_outpainting_log",
    )

    pipeline += gp.Snapshot(
        dataset_names={raw: "raw", gt_lsds: "gt_lsds", pred_lsds: "pred_lsds"},
        output_dir="snapshots/lsd_outpainting_snapshots",
